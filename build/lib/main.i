...
# 1 "source\\/Playground.h" 1

       
# 1 "source\\/Vectors.h" 1
...
# 4 "source\\/Playground.h" 2
# 1 "source\\/SoundPlayer.h" 1

       


# 1 "source\\/SoundStructs.h" 1
...
static inline void Sound()
{
 ...
 {
  ++channel1Counter;
  duration = SelectedSong->Rhythm1->noteDurations[channel1Counter];
 }
...
# 1 "source\\/FirstSong.h" 1

       
# 1 "source\\/Notes.h" 1

       
# 4 "source\\/FirstSong.h" 2
